...
if __name__ == '__main__':
    ...
    # 添加任务,时间间隔20min
    scheduler.add_job(crawlJob_search, 'interval', minutes = 20, id = 'crawlJob_search')
    # 添加任务,时间间隔20min
    scheduler.add_job(crawlJob_Stream, 'interval', minutes = 20, id = 'crawlJob_stream')
    scheduler.start()